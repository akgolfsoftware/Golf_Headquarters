...
(eyebrow||index)?React.createElement('div',{style:{display:'flex',alignItems:'center',gap:'12px',fontFamily:'var(--font-mono)',fontSize:'var(--text-micro)',letterSpacing:'.18em',color:onDark?'var(--navy-300)':'var(--ink-400)'}},
...
title?React.createElement('h2',{style:{fontFamily:'var(--font-display)',fontSize:'32px',fontWeight:'var(--weight-black)',letterSpacing:'-.035em',lineHeight:1.08,margin:0,color:onDark?'var(--white)':'var(--ink-900)'}},title):null,
description?React.createElement('p',{style:{margin:0,fontSize:'var(--text-base)',lineHeight:1.55,color:muted,textWrap:'pretty'}},description):null
),
action||null
);
}