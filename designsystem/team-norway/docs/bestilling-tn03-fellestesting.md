...
Én skjerm, i dybden. Utdyper TN-03 i `docs/bestilling-batch-2.md` — den bestillingen gjelder
fortsatt for kontekst og regler, denne går i dybden på selve skjermen.
...
Dette er skjermen som ikke finnes noe sted i dag, og som avgjør om en testdag i det hele tatt
kan føres i appen. Bygg i dette designsystemet — `readme.md` og `tokens/` er fasit, ikke
`SKILL.md`.
