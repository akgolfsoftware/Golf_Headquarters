# Bestilling: TN-Workdesk batch 2

Anders besluttet 30.08.2026 at Team Norways egne skjermer designes i dette systemet (Claw-brandingen), ikke i Train-lock, og at TN-rødt er `#D70232` målt fra logofilen. Registrert i AK Golf HQ som `.claude/rules/beslutninger.md` §TEAM NORWAY-SKJERMENE DESIGNES I CLAW-BRANDINGEN og MASTERPLAN STEG 11 rad N7b.
