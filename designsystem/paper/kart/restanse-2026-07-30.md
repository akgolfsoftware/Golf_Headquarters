...
Skrevet 30.07.2026, etter dekningsvurderingen samme dag. Erstatter ikke
`kart/arbeidsordre-komplett-system-2026-07-29.md` — den definerer skjermsporet.
Dette dokumentet definerer **systemsporet**: hva som skal til før biblioteket selv
holder standarden, og hele den gamle kanonen er portet inn.
...
Her er forslag per seksjon, bygget på funksjonskartet og den gamle kanonens
ui_kits-skjermer. **Ingenting designes før hver rad er godkjent eller avvist.**
...
**Beslutning:** hvem kan publisere en ukeplan til spiller — kun deg, eller også Markus
...
ikke meldes ferdig uten den. Det er den ene porten som krever at du — eller en
