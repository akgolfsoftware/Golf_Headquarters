...
```jsx
<Toast tone="ok">Ukeplan publisert til Øyvind</Toast>
...
- Teksten skal kunne leses i det halvsekundet den er der: «Ukeplan publisert til Øyvind», ikke «Handlingen ble utført».
