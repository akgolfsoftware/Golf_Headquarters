...
export const SKJERM_MAPPING: SkjermMapping[] = [
  ...
  },
  {
    ...
    notat: "Rute byttet 08.09 (fase 1, økt 4) fra redirect-adressen /admin/agenticos/godkjenn til /admin/ko?fane=agentgodkjenn (MASTERPLAN 15.1). Fasit-rammen er 620 px bred uten fast høyde (måles fra elementet). Panel-modus som AO-03. Tall kommer i oppgave 4.5.",
  },
  {
    label: "AG-04 Stall",
    rute: "/admin/spillere",
