...
Ekstern oppskrift. Ved konflikt vinner `ak-sikkerhet`, `ak-personvern`, `AGENTS.md` og produktreglene. Ikke kjør angrep mot produksjon. Ikke logg eller send persondata ut av repoet. Databaseendringer følger `.claude/rules/gotchas.md`.
