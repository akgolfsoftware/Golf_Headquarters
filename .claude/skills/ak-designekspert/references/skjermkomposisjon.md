...
- **Mobile-first** for PlayerHQ og foreldreportal; desktop-first for AgencyOS-arbeidsflater (workbench, analyse).
...
3. Mobilbredde (390px) — ingen klipping, touch-mål ≥ 44px
