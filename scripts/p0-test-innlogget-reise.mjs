...
async function main() {
  ...
  for (const navn of [
    ...
    "P0_TALENT_EMAIL", "P0_TALENT_PASSWORD", "P0_ADMIN_EMAIL", "P0_ADMIN_PASSWORD",
    "P0_PLAYER_ID", "P0_FOREIGN_ID",
    "P0_WB_ID", "P0_LOKAL_WB_ID", "P0_FREMMED_WB_ID", "P0_FLYTT_WB_ID", "P0_REDIGER_PLAN_ID", "P0_V2_ID", "P0_PLAN_ID", "P0_WB_TALL", "P0_V2_REPS", "P0_V2_TREFF", "P0_PLAN_TALL",
  ]) {
