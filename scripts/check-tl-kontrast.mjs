...
const md = [
  ...
  "",
  `GENERERT av \`scripts/check-tl-kontrast.mjs\` fra \`src/styles/train-lock-tokens.css\`. Ikke rediger. Målt ${new Intl.DateTimeFormat("sv-SE", { timeZone: "Europe/Oslo" }).format(new Date())}: ${rader.length} par, ${brudd} brudd.`,
  "",
