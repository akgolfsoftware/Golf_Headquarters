# Custom prompt for Mini-batch 2-B - CoachHQ drift
...
4. `wireframe/design-batches/batch-2-list-filter/mini-batches/2-B.md` (selve mini-batch-spec)
5. Alle HTML-filer listet i `2-B-vedlegg.txt` (5 stk)

---

# PROMPT (kopier fra og med denne linja):

Jeg har lastet opp et komplett designsystem (branding-style-guide.html + design-system-v2.md + 20 fonter) og en mini-batch-spec (2-B.md) med 5 skjermer som skal designes.
...
For hver skjerm:
1. Les pakken i 2-B.md (Pakke 1, Pakke 2, ..., Pakke 5)
