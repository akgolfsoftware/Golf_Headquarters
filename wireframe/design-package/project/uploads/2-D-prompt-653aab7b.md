# Custom prompt for Mini-batch 2-D - PlayerHQ coach + 4 modaler
...
4. `wireframe/design-batches/batch-2-list-filter/mini-batches/2-D.md` (selve mini-batch-spec)
5. Alle HTML-filer listet i `2-D-vedlegg.txt` (6 stk)

---

# PROMPT (kopier fra og med denne linja):

Jeg har lastet opp et komplett designsystem (branding-style-guide.html + design-system-v2.md + 20 fonter) og en mini-batch-spec (2-D.md) med 7 skjermer som skal designes.

## Hva jeg vil

Generer alle 7 skjermer i denne mini-batchen, EN OM GANGEN.

For hver skjerm:
1. Les pakken i 2-D.md (Pakke 1, Pakke 2, ..., Pakke 7)
...
Begynn med Pakke 1: Coaching-planer

Vis meg resultatet, og vent paa "neste" foer du gaar til Pakke 2.

---

**Naar alle 7 skjermer er ferdige:**
- Lag en samlet oversikt med alle 7 thumbnails
