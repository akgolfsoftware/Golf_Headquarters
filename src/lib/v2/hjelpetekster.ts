...
const RAW = {
  ...
  gjentaOkt: {
    tittel: "Gjenta",
    forklaring:
      "Som i kalenderen: Av, hver uke eller annenhver uke. Velg hvor mange ganger totalt. Hver gang blir en egen økt du kan flytte eller slette uten å påvirke de andre.",
  },
  tonnasje: {
    tittel: "Tonnasje",
    forklaring:
