...
export const UI = {
  ...
  weekPlan: "Ukeplan",
  selectedWeekTitle: "Valgt uke",
  formulaTitle: "Formel",
  calendarTitle: "Ukekalender",
  selectDay: "Velg dag",
  timeLevels: "Tidsnivå",
  planFor: "Planlegger for",
  titlePlayer: "Min uke",
  ...
  periodPlan: "Periodeplan",
  periodVolume: "Periodevolum",
  periodProgress: "Gjennomført mot plan",
  periodDistribution: "Fordeling",
  periodTimeline: "Tidslinje",
  periodPyramid: "Fordeling på pyramiden",
  publishPeriod: "Publiser periode",
  openPeriod: "Åpne periode",
  noPeriodTitle: "Ingen periode valgt",
  noPeriodBody: "Legg inn perioder i årsplanen for å bygge periodevisningen.",
  ...
  emptySourcesBody: "Ingen øvelser eller maler er tilgjengelige for denne spilleren.",
