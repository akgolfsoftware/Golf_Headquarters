...
export interface KanoniskGruppe {
  ...
  level: string | null;
  // Group.kind: kontrakt | program | adhoc
  kind: "kontrakt" | "program";
}

export const KANONISKE_GRUPPER: readonly KanoniskGruppe[] = [
  { slug: "gfgk-mini", navn: "GFGK Junior Mini U10", program: "GFGK_MINI", level: "A5", kind: "program" },
  { slug: "gfgk-basis", navn: "GFGK Junior Basis U13", program: "GFGK_BREDDE", level: "A4", kind: "program" },
  { slug: "gfgk-utvikling", navn: "GFGK Junior Utvikling U15", program: "GFGK_BREDDE", level: "A3", kind: "program" },
  { slug: "gfgk-elite", navn: "GFGK Junior Elite U19", program: "GFGK_ELITE", level: "A2", kind: "program" },
  { slug: "wang-toppidrett", navn: "WANG Toppidrett Fredrikstad", program: "WANG_TOPPIDRETT", level: null, kind: "kontrakt" },
  { slug: "wang-ung", navn: "WANG Ung Fredrikstad", program: "WANG_UNG", level: null, kind: "kontrakt" },
  { slug: "ak-golf-academy", navn: "AK Golf Academy", program: "AK_ACADEMY", level: null, kind: "program" },
  { slug: "ak-golf-junior-academy", navn: "AK Golf Junior Academy", program: "AK_ACADEMY_JUNIOR", level: null, kind: "program" },
] as const;
