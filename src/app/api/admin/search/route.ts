...
const ROUTES: Omit<SearchRoute, "id">[] = [
  ...
  { label: "Meldinger", description: "Innboks for spiller-meldinger", href: "/admin/meldinger" },
  { label: "Tester", description: "SG- og fys-tester", href: "/admin/tester" },
  { label: "Lokasjoner", description: "Anlegg og fasiliteter", href: "/admin/locations" },
  { label: "Fasiliteter", description: "Fasiliteter under hvert anlegg", href: "/admin/facilities" },
