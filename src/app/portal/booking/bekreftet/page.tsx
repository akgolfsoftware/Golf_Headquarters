    ...
    <div className="mx-auto max-w-xl space-y-6 px-4 pb-20 py-6 md:space-y-8 md:px-0 md:pb-0 md:py-8">
      ...
      <div className="flex flex-col gap-2 sm:flex-row">
        <a
          ...
          className="inline-flex flex-1 items-center justify-center gap-2 rounded-md border border-input bg-card px-4 py-2 text-sm font-medium text-foreground hover:border-primary hover:text-primary"
        >
        ...
        <Link
          href="/portal"
          className="inline-flex flex-1 items-center justify-center gap-2 rounded-md bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground hover:opacity-90"
        >
