            ...
            {slots.map((s) => {
              ...
              return (
                <Link
                  ...
                  className="flex min-h-11 items-center justify-center rounded-xl border border-border bg-card px-4 py-2 text-center font-mono text-sm tabular-nums text-foreground transition-colors hover:border-primary hover:bg-primary/5"
                >
                  {klokke}
                </Link>
              );
