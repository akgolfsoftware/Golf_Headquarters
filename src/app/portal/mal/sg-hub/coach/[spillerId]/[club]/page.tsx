...
// Coach-modus speil av /portal/mal/sg-hub/[club]/page.tsx — viser spillerens
// data og merker visningen tydelig som "Coach-modus". Når shot-annotasjons-UI
// senere bygges inn i hovedversjonen, importeres ShotAnnotationPopover her
// med canEdit=true (vs spillerens canEdit=false).
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <SummaryCard
          ...
          label="Optimum Speed"
          value={
            smash.optimumSpeed > 0 ? `${smash.optimumSpeed} mph` : "—"
          }
          sub={
