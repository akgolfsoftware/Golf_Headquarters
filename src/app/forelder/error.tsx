...
export default function ForelderError({ error, reset }: Props) {
  useEffect(() => {
    console.error("[forelder/error]", error);
  }, [error]);
  ...
  return (
    <div className="mx-auto flex min-h-[60vh] max-w-2xl flex-col justify-center gap-4 px-6 py-16">
      ...
      <p className="max-w-md text-sm text-muted-foreground">
        Vi støtte på en uventet feil. Prøv igjen, eller gå tilbake til foreldre-oversikten.
      </p>
      {error.digest && (
      ...
      <div className="mt-4 flex flex-col gap-2 sm:flex-row">
        ...
        <Button as={Link} href="/forelder" variant="secondary">
