/**
 * PILOT — PlayerHQ Live Active (mid-rep)
 * Bygd direkte fra wireframe/_extracted/live-states/01-live-active-mid-rep.html
 * URL: /live-active-demo
 *
 * Fullskjerm dark live-modus, rep-logging mid-rep state.
 * Følger mønster fra live-session-demo, live-tapper-demo, live-intro-demo.
 */

import { X, Pause, Check } from "lucide-react";

export default function LiveActiveDemo() {
  // Ring math — 12 av 25 rep
  const radius = 228;
  const circumference = 2 * Math.PI * radius; // ~1432.57
        ...
        <div className="relative mt-8 flex h-[480px] w-[480px] items-center justify-center">
          ...
          >
            ...
            <circle
              ...
              style={{ filter: "drop-shadow(0 0 10px rgba(209,248,67,0.35))" }}
            />
          </svg>
