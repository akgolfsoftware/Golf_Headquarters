/**
 * Preview-rute (offentlig, ingen auth) for PlayerHQ Aarsplan
 * (`/portal/tren/aarsplan`). Rendrer <Aarsplan> med hardkodet demo-data som
 * matcher v10-fasiten (public/design-handover/_screens/pl-aarsplan.png) —
 * ny spiller "Mathias", tier GRATIS, TOM-TILSTAND (ingen sesongplan for 2026).
 *
 * Mobil (≤640px): ren innholds-kolonne, sidebar skjult — primaer-fasit.
 * Desktop (≥1024px): venstre PlayerHQ-sidebar (ak-logo + PLAYERHQ · GRATIS +
 * Ny økt + 5-items nav, "Planlegge" aktiv) + sentrert kolonne paa cream-bg.
 * Skall gjenbrukt fra playerhq-preview/hjem.
 *
...
import { Aarsplan, type AarsplanData } from "@/components/portal/aarsplan/aarsplan";

// ── Demo-data — matcher pl-aarsplan.png (tom-tilstand, ny GRATIS-spiller) ──
const demoAarsplan: AarsplanData = {
  aar: 2026,
  fornavn: "Mathias",
  faser: [],
  hrefs: {
...
// ── Desktop-sidebar (preview-statisk, matcher PlayerHQ-skallets formspraak) ──
type NavItem = {
  href: string;
  label: string;
