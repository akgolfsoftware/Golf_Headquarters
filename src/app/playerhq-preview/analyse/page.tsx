/**
 * Preview-rute (offentlig, ingen auth) for PlayerHQ Analyse-hub.
 * Rendrer <AnalyseHub> med hardkodet demo-data som matcher v10-fasiten
 * (public/design-handover/_screens/pl-analyse.png) — TOM-TILSTAND for ny
 * spiller uten loggførte økter.
 *
...
// ── Demo-data — matcher pl-analyse.png (tom-tilstand, ingen loggførte økter) ──
const demoAnalyse: AnalyseHubData = {
  spillerNavn: "Markus R.P.",
  periodeLabel: "30 dager",
  totalTimer: 0,
  nettoSg: 0,
  antallOkter: 0,
  akser: [], // tom = tom-tilstand (fasit)
  hrefs: {
