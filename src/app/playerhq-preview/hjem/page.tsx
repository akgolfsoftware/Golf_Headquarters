/**
 * Preview-rute (offentlig, ingen auth) for PlayerHQ Hjem.
 * Rendrer <PlayerHome> med hardkodet demo-data som matcher v10-fasiten
 * (public/design-handover/_screens/pl-hjem.png) — ny spiller "Mathias",
 * tier GRATIS, tom-tilstand (ingen økt, ingen SG, ingen turnering).
 *
...
// ── Demo-data — matcher pl-hjem.png (tom-tilstand, ny GRATIS-spiller) ──
const demoHome: PlayerHomeData = {
  user: {
    fornavn: "Mathias",
    initialer: "MS",
    tier: "GRATIS",
  ...
  caddie: {
    ...
    cta: { label: "Plan ny økt", href: "/portal/ny-okt" },
  },
  hrefs: {
...
const NAV: NavItem[] = [
  { href: "/portal", label: "Oversikt", Icon: LayoutDashboard, active: true },
