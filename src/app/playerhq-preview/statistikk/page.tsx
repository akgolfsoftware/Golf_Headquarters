/**
 * Preview-rute (offentlig, ingen auth) for PlayerHQ Statistikk.
 * Rendrer <Statistikk> med hardkodet demo-data som matcher v10-fasiten
 * (public/design-handover/_screens/pl-stats.png) — ny GRATIS-spiller,
 * tom-tilstand (0 runder ⇒ "Statistikk vises når du har logget runder.").
 *
...
// ── Demo-data — matcher pl-stats.png (tom-tilstand, ny GRATIS-spiller) ──
const demoStatistikk: StatistikkData = {
  eyebrow: "STATS · 2026 · 0 RUNDER",
  aktivTab: "oversikt",
  metrikker: [], // tom-tilstand jf. fasit
  hrefs: {
    loggRunde: "/portal/stats/runder",
    metrikk: (id) => `/portal/stats/${id}`,
  },
};
...
export default function PlayerHqStatistikkPreviewPage() {
  return (
    <div className="flex min-h-screen bg-background">
      <PreviewSidebar />
      <main className="min-w-0 flex-1 bg-[var(--color-player-content)] lg:bg-background">
        <Statistikk data={demoStatistikk} />
      </main>
    </div>
  );
}
