/**
 * Preview-rute (offentlig, ingen auth) for PlayerHQ TrackMan.
 * Rendrer <Trackman> med hardkodet demo-data som matcher v10-fasiten
 * (public/design-handover/_screens/pl-trackman.png) — tom-tilstand:
 * ingen TrackMan-økt importert ennå.
 *
...
import {
  Trackman,
  type TrackmanData,
} from "@/components/portal/trackman/trackman";

// ── Demo-data — matcher pl-trackman.png (tom-tilstand, ingen import) ──
const demoTrackman: TrackmanData = {
  eyebrow: "TRACKMAN · SESJONSANALYSE",
  okterCount: 0,
  hrefs: {
    importTrackman: "/portal/mal/trackman/ny",
    importCsv: "/portal/mal/trackman/ny",
    importHtml: "/portal/mal/trackman/ny",
  },
};
