/**
 * PILOT — BookSessionModal · Steg 1 · PRO-tier (full tilgang)
 * Bygd direkte fra wireframe/modal-C/01-book-session-steg1-pro.html
 * URL: /book-session-pro-demo
 *
 * Mock-data: Markus (PRO-konto) — alle fasiliteter åpne, PRO-badge i header.
 */
...
export default function BookSessionProDemo() {
        ...
        <header className="flex items-start justify-between gap-4 border-b border-border px-8 pb-5 pt-7">
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="inline-flex items-center gap-1 rounded-full bg-accent px-2 py-0.5 font-mono text-[10px] font-bold uppercase tracking-[0.07em] text-accent-foreground">
