    ...
    <form onSubmit={send} className="space-y-4">
      <label className="block">
        ...
        <input
          ...
          required
          className="w-full rounded-md border border-input bg-card px-4 py-4 text-sm text-foreground outline-none focus:border-ring focus:ring-2 focus:ring-ring/30"
        />
      </label>
