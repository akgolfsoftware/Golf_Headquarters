...
export default async function Analytics() {
  ...
  const [
    ...
    bookinger30d,
    inntektAgg,
    // Spillere med siste økt for aktivitetstabell
    spillereListe,
    // Bookinger for ukedag-histogram
    bokningerMedDato,
  ] = await Promise.all([
  ...
  // Gjennomsnittlig sesjonstid (stub — durationMin er på TrainingPlanSession, ikke loggen)
  ...
  // Aktivitetstabell: bygg rad per spiller
  const aktivitetsRader = spillereListe.map((spiller) => {
    // Sesjoner med log-timestamp (flattened)
    ...
    const tretti2 = new Date();
    tretti2.setDate(tretti2.getDate() - 30);
    const seksti2 = new Date();
  ...
  // Bookinger per ukedag (0=mandag, 6=søndag)
  const ukedager = ["Man", "Tir", "Ons", "Tor", "Fre", "Lør", "Søn"];
  const ukedagTellere = [0, 0, 0, 0, 0, 0, 0];
  for (const b of bokningerMedDato) {
    // getDay(): 0=søndag, 1=mandag... Konverter til man=0..søn=6
    ...
    <div className="space-y-8">
      ...
      {!harData ? (
        ...
        <>
          ...
          <section className="space-y-4">
            <div className="flex flex-wrap items-baseline justify-between gap-4">
              <h3 className="font-display text-lg font-semibold tracking-tight">
                Spiller{" "}
                <em className="font-normal italic text-primary">aktivitet</em>
              </h3>
              <span className="font-mono text-[10px] uppercase tracking-[0.10em] text-muted-foreground">
                Siste 30 dager
              </span>
          ...
          <section className="rounded-xl border border-border bg-card p-6 shadow-sm">
            <div className="flex items-start justify-between gap-4">
              <div>
                <h3 className="font-display text-lg font-semibold tracking-tight">
                  Bookinger per{" "}
                  <em className="font-normal italic text-primary">ukedag</em>
                </h3>
              ...
              {ukedager.map((dag, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative flex w-full flex-col justify-end overflow-hidden rounded-sm bg-secondary h-28">
                      <div
          ...
          {/* Pending approvals — nedre varselboks */}
          {pendingApprovals > 0 && (
