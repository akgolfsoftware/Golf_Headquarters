/**
 * AgencyOS Spillere & Stall — Precision Athletics standard.
 * Full oversikt over spillerstallen med formstatus, snittscorer, ACWR og analysetilgang.
 */
...
export default async function AdminSpillerePage() {
