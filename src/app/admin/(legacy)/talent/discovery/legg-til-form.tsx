...
export function LeggTilForm({
  ...
  if (state.ok) {
    return (
      <span className="inline-flex items-center rounded-full bg-primary/10 px-4 py-1 text-[11px] font-medium text-primary">
        Lagt til
      </span>
    );
  }
    ...
    >
      ...
      <label className="flex flex-col gap-1">
        ...
        <select
          ...
          required
          defaultValue="U14"
          className="rounded-md border border-input bg-background px-4 py-2 text-[12px]"
        >
          {NIVAA.map((n) => (
