      ...
      >
        {secret ? (
          <div className="p-6">
            ...
            <code className="block break-all rounded-md border border-border bg-muted/50 px-4 py-4 font-mono text-xs text-foreground">
              {secret}
            </code>
            <button
              type="button"
              ...
              <div>
                ...
                <div className="space-y-1.5">
                  {SCOPES.map((s) => (
                    <label
                      key={s.value}
                      className="flex cursor-pointer items-center gap-2 rounded-md border border-input bg-card px-4 py-2 text-sm hover:border-border"
                    >
                      <input
                        type="checkbox"
