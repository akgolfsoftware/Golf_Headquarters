 ...
 * Bygd direkte fra wireframe/design-files-v2/01-daglig-brief-default.html
...
export default function DagligBriefDemo() {
  return (
    <div className="min-h-screen bg-background text-foreground px-10 py-10">
