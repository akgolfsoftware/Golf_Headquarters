    ...
    <div className="flex flex-col gap-6">
      ...
      <section>
        <div
          ...
          style={{
            background: AK.farge.forestMerkeA4,
            borderColor: AK.farge.forestMerkeA18,
          }}
        >
  ...
  if (active) {
    return (
      <button
        ...
        style={{
          background: tone ? toneBg[tone] : `var(--surface-alt,${AK.farge.sandMerke})`,
          ...
          <div>
            ...
            <div className="rounded-xl border border-border bg-card p-6">
              ...
              <div
                ...
                style={{
                  background: AK.farge.rodMerkeA8,
                  borderColor: AK.farge.rodMerkeA25,
                }}
              >
                <TriangleAlert
    ...
    <div className="flex flex-col gap-6">
      ...
      <section>
        <div
          ...
          style={{ background: `var(--surface-alt,${AK.farge.sandMerke})` }}
        >
          <div>
