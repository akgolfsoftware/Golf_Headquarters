...
export const TRAINING_CAMPS: Treningssamling[] = [
  {
    name: "Samling med WANG Oslo",
    dato: "18.–24. jan 2027",
    hvor: "Desert Springs",
    status: "Planlegges",
    desc: "Felles treningsuke med WANG Oslo.",
    arrangor: "WANG sentralt",
    pamelding: "Info kommer",
    pamfrist: "—",
    egenandel: "Ikke bestemt",
    iso: "2027-01-18",
    fristIso: null,
  },
];
