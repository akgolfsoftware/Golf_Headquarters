...
export const COACH_PERIODS: CoachPeriode[] = [
  {
    ...
    fokus:
      "Runde av høstens konkurransesesong og gli over i grunntrening. Vedlikehold av spill, gradvis økt fysisk volum.",
    pyr: { FYS: 10, TEK: 10, SLAG: 20, SPILL: 25, TURN: 35 },
    faseFokus: "Auto",
    maal: [
      "Fullføre høstturneringene skadefri",
      "Etablere NGF-baseline på fysiske tester",
      "Beholde scoringsspill mens FYS-volum øker",
    ],
    tester: ["NGF fysiske inngangstester (aug)", "Baseline TrackMan 7-jern"],
    iup: "IUP-checkpoint oktober",
  ...
  },
  {
    ...
    fokus:
      "Bygg teknisk og fysisk fundament. Mest FYS og TEK. Læringsfasen «Uten ball» og «Lav hastighet» prioriteres over data og turnering.",
    pyr: { FYS: 50, TEK: 35, SLAG: 10, SPILL: 5, TURN: 0 },
    faseFokus: "Uten ball / Lav hastighet",
    maal: [
      "Øke CS-baseline 3 % på driver",
      "Knebøy 1RM +7,5 kg med bevart teknikk",
      "Automatisere nøytral P1/P4 uten ball",
    ],
    tester: ["Vintertester teknikk + fysisk (jan)", "Retest maksstyrke (des)"],
    iup: "IUP-checkpoints des + mars",
  ...
  },
  {
    ...
    fokus:
      "Spesialisér mot slag og scoringsspill. Mer «Auto»-fase, høyere CS og miljø. Press økes mot Krav og Utfordring.",
    pyr: { FYS: 15, TEK: 20, SLAG: 35, SPILL: 25, TURN: 5 },
    faseFokus: "Lav hastighet / Auto",
    maal: [
      "Wedge-spredning 60 m under 6 m",
      "Smash factor 7-jern ≥ 1,38",
      "«Auto»-fase på tre nøkkelslag",
    ],
    tester: ["Sesongtester (mai)", "Launch monitor – full wedge-matrise"],
    iup: "IUP-checkpoint mars",
  ...
  },
  {
    ...
    fokus:
      "Omsett trening til score. Konkurransesimulering, «Auto»-fase, press mot Konkurranse. Toppe form mot prioriterte turneringer.",
    pyr: { FYS: 10, TEK: 10, SLAG: 20, SPILL: 25, TURN: 35 },
    faseFokus: "Auto",
    maal: [
      "Snittscore under 76 i tellende runder",
      "GIR ≥ 55 % i turnering",
      "Opp-og-inn ≥ 60 %",
    ],
    tester: ["Konkurransestatistikk per runde"],
    iup: "IUP-checkpoint juni",
    turneringer: [
      "Regionsmesterskap Øst",
      "Lag-NM kvalifisering",
      "NM Junior",
      "Srixon Tour finale",
    ],
  },
...
export const FASE_TRINN = [
  {
    n: 1,
    name: "Uten ball",
    desc: "Grunnbevegelse. Tørrsving, speil, ingen ball.",
  },
  {
    n: 2,
    name: "Lav hastighet",
    desc: "Bevegelsen bygges opp med ball i redusert tempo.",
  },
