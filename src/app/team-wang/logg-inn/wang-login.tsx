...
const SEED: DemoBruker[] = [
  {
    ...
    navn: "Emma Larsen",
    klasse: "VG2",
    epost: "emma.larsen@wang.no",
    foreldre: ["ida.strand@gmail.com", "per.larsen@gmail.com"],
  },
  {
    id: 2,
    navn: "Jonas Bakke",
    klasse: "VG1",
    epost: "jonas.bakke@wang.no",
    foreldre: ["marius.dahl@gmail.com"],
  },
  {
    id: 3,
    navn: "Sofie Holm",
    klasse: "VG3",
    epost: "sofie.holm@wang.no",
    foreldre: ["kari.holm@gmail.com", "tom.holm@gmail.com"],
  },
  {
    id: 4,
    navn: "Marius Dahl",
    klasse: "VG2",
    epost: "marius.dahl@wang.no",
    foreldre: ["anne.dahl@gmail.com"],
  },
];
...
function Login({ onAdmin }: { onAdmin: () => void }) {
  ...
  return (
    ...
    >
      ...
      >
        <Image
          src="/team-wang/wang-logo-vertical.svg"
          alt="WANG"
          width={48}
          height={76}
          style={{
        ...
        >
          ...
          />
          <Link
            href="/auth/login?next=/team-wang"
        ...
        >
          For elever: din{" "}
          <strong style={{ color: "var(--text-primary)" }}>@wang.no</strong>
          -adresse. For foreldre: e-posten du er registrert med hos skolen.
          Sikker innlogging via AK Golf HQ.
        </p>
    ...
    >
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          >
            Elever og foreldre · WANG Fredrikstad Golf
          </div>
        </div>
        <button
          onClick={onBack}
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          >
            Registrer hver elev med sin WANG-epost og foreldrenes e-post. Dette
            gir tilgang til gruppechat og innlogget innhold.{" "}
            <strong style={{ color: "var(--text-primary)" }}>Demo</strong> –
            kobles til skolens brukerbase i produksjon.
          </p>
        </div>
      </div>
      ...
      <section className="wang-card" style={{ padding: 22 }}>
        ...
        >
          ...
          <Felt
            label="WANG-epost"
            type="email"
            placeholder="emma.larsen@wang.no"
            value={wangEpost}
            onChange={setWangEpost}
          />
          <Felt
            label="Forelder 1 – e-post"
            type="email"
          ...
          />
          <Felt
            label="Forelder 2 – e-post (valgfritt)"
            type="email"
            placeholder="forelder@epost.no"
            value={f2}
            onChange={setF2}
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          {brukere.map((u) => (
            ...
            >
              ...
              <button
                onClick={() =>
                  setBrukere((b) => b.filter((x) => x.id !== u.id))
                }
                className="wang-pressable"
                aria-label={`Fjern ${u.navn}`}
                style={{
                  flexShrink: 0,
                  border: "none",
