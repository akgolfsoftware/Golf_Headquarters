/**
 * v2-forhåndsvisning — PlayerHQ Meg · Abonnement (retning C). Egen top-level
 * route-group (v2preview) som IKKE arver PortalShell — kun root-layout.
 * V2Shell leverer chrome-en (IkonRail/BunnNav, aktiv «meg»), MegAbonnementV2
...
export default async function V2MegAbonnementPreviewPage({
  searchParams,
}: {
  ...
  // Avledninger — 1:1 med src/app/portal/meg/abonnement/page.tsx.
