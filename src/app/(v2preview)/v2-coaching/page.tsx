/**
 * v2-forhåndsvisning — MARKEDSSIDE Coaching (/coaching, retning C).
 * OFFENTLIG: ingen auth-guard, egen marketing-chrome (MRamme), IKKE V2Shell.
 * Rendrer MarkedCoachingV2 1:1 mot mockup-fasit ui_kits/v2/marketing.jsx.
 */
...
export default function V2CoachingPreviewPage() {
