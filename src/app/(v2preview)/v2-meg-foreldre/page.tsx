/**
 * v2-forhåndsvisning — PlayerHQ Meg · Foresatte (retning C). Egen top-level
 * route-group (v2preview) som IKKE arver PortalShell — kun root-layout. V2Shell
 * leverer chrome-en (IkonRail/BunnNav), MegForeldreV2 rendrer innholds-stacken.
 *
...
export default async function V2MegForeldrePreviewPage() {
