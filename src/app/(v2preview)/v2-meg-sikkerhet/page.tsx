/**
 * v2-forhåndsvisning — PlayerHQ Meg · Sikkerhet (retning C). Egen top-level
 * route-group (v2preview) som IKKE arver PortalShell — kun root-layout.
 * V2Shell leverer chrome-en (IkonRail/BunnNav, aktiv «meg»), MegSikkerhetV2
 * rendrer innholds-stacken.
 *
 * Auth + dataloader gjenbruker den ekte /portal/meg/sikkerhet-siden:
...
export default async function V2MegSikkerhetPreviewPage() {
