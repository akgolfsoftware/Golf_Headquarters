/**
 * v2-forhåndsvisning — PlayerHQ Meg · Helse (retning C). Egen top-level
 * route-group (v2preview) som IKKE arver PortalShell — kun root-layout.
 * V2Shell leverer chrome-en (IkonRail/BunnNav), MegHelseV2 rendrer stacken.
 *
 * Auth + dataloader er 1:1 med den ekte /portal/meg/helse-siden: siste 14
...
import { lagreHelseEntry } from "@/app/portal/meg/helse/actions";
...
export default async function V2MegHelsePreviewPage() {
  const user = await requirePortalUser();

  // Siste 14 dagers logg, nyest først (identisk med /portal/meg/helse).
