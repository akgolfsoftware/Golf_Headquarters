/**
 * v2-forhåndsvisning — Marketing: PlayerHQ-produktside (M2, retning C).
 * OFFENTLIG flate: ingen auth-guard, ingen dataloader (markedsside). Egen
...
export default function V2PlayerHQSidePreviewPage() {
