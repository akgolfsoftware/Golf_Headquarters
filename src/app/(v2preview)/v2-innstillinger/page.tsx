/**
 * v2-forhåndsvisning — PlayerHQ Innstillinger (retning C). Egen top-level
 * route-group (v2preview) som IKKE arver PortalShell — kun root-layout.
 * V2Shell leverer chrome-en (IkonRail/BunnNav, aktiv «meg»), InnstillingerV2
...
export default async function V2InnstillingerPreviewPage() {
