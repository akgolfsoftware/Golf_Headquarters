...
const COACHER: CoachProfil[] = [
  {
    ...
    bio: [
      "Anders har coachet golfspillere i mer enn et tiår, fra første time til nasjonale konkurranseutøvere. Bakgrunnen kombinerer egen turneringskarriere med formell trenerutdanning og år med studier hos internasjonale svinginstruktører, Trackman-data og moderne treningsmetodikk.",
