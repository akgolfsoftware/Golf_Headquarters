/**
 * MIDLERTIDIG: den LYSE forsiden på AK Golf Design System
 * (Claude Design 87aa23fb — dagens designautoritet, 21.09.2026).
 *
 * Anders valgte den mørke (`/forside-ny`) 21.09.2026. Denne blir stående til
 * valget er endelig, så de to kan sammenliknes i nettleseren og ikke bare
 * beskrives. Faller valget på den mørke for godt, slettes denne ruta og
 * `ForsideDS` sammen med `/`-byttet.
 *
...
export const metadata: Metadata = {
  title: "Forside (lys) — forhåndsvisning",
  robots: { index: false, follow: false },
};

export default function ForsideNyLysPage() {
  return (
