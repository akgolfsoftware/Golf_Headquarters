...
/**
 * GirPctExplorer — interaktiv sammenligning med slider.
 *
 * Bruker:
 *   1. Drar slider mellom min/maks GiR-prosent
...
export function GirPctExplorer({
  datapunkter,
}: {
  ...
  // Default: norsk amatør-snitt ~50 %
  const [dittTall, setDittTall] = useState(50);
        ...
        <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 sm:py-16">
          <div className="text-center">
            <h2 className="font-display text-2xl font-semibold tracking-tight sm:text-3xl">
              Hvor mange greener treffer{" "}
              <em className="font-normal italic text-primary">du</em>?
            </h2>
            <p className="mx-auto mt-3 max-w-xl text-sm text-muted-foreground">
              Dra slideren til din gjennomsnittlige GiR-prosent, og se
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs text-muted-foreground">
                      Du treffer greener oftere enn {percentile}% av PGA-spillere.
                    </p>
                  </div>
                </div>
              </div>
