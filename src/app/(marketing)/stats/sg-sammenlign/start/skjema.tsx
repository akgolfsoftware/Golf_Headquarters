      ...
      {feil && (
        <div
          style={{
            ...
            gap: 10,
            background: AK.farge.feilMerkeA8,
            border: `1px solid ${AK.farge.feilMerkeA30}`,
            borderRadius: 10,
            padding: "12px 16px",
            marginBottom: 24,
            fontSize: 14,
          ...
          >
            <div
              style={{
                ...
                borderRadius: 12,
                padding: "12px 16px",
                boxShadow: `0 1px 3px ${AK.farge.inkMerkeA6}`,
              ...
              {refSpiller && (
                <span
                  style={{
                    ...
                    background: AK.farge.forestMerkeA8,
                    padding: "2px 8px",
                    borderRadius: 4,
                  }}
                >
            ...
            {suggestions.length > 0 && (
              <div
                style={{
                  ...
                  borderRadius: 10,
                  boxShadow: `0 8px 24px ${AK.farge.inkMerkeA10}`,
                  zIndex: 50,
                  overflow: "hidden",
                  marginTop: 4,
                }}
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    boxShadow: selected
                      ? `0 4px 12px ${AK.farge.forestMerkeA20}`
                      : "none",
                  }}
                >
                  <div
              ...
              {(
                ...
                <button
                  ...
                  style={{
                    ...
                    boxShadow:
                      modus === id ? `0 2px 6px ${AK.farge.forestMerkeA25}` : "none",
                  }}
                >
                  {label}
                </button>
