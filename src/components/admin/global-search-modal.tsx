...
const ACTIONS: Action[] = [
  ...
  },
  {
    id: "approvals",
    label: "Kø",
    description: "Alt som krever deg i dag — godkjenninger, agent-kø, tester, dubletter",
    keywords: ["kø", "ko", "godkjenninger", "approvals", "inbox", "agent", "pending", "queue"],
    icon: ClipboardCheck,
    kind: { type: "navigate", href: "/admin/ko" },
  },
  // MASTERPLAN 15.1: fanene er søkbare hver for seg, så Anders slipper å
  // vite at de bor på samme adresse.
  {
    id: "ko-agent",
    label: "Agent-kø",
    description: "Klar, pågår og venter på godkjenning",
    keywords: ["agent", "jarvis", "agenticos", "kø", "kjøring"],
    icon: Bot,
    kind: { type: "navigate", href: "/admin/ko?fane=agentko" },
  },
  {
    id: "ko-tester",
    label: "Foreslåtte tester",
    description: "Tester spillere har laget og vil ha godkjent",
    keywords: ["tester", "foreslåtte", "egen test", "godkjenn test"],
    icon: ClipboardCheck,
    kind: { type: "navigate", href: "/admin/ko?fane=tester" },
  },
  {
    id: "ko-dubletter",
    label: "Turneringsdubletter",
    description: "Manuelle turneringer som ligner på en importert",
    keywords: ["dubletter", "turnering", "merge", "slå sammen"],
    icon: Copy,
    kind: { type: "navigate", href: "/admin/ko?fane=dubletter" },
  },
  {
    id: "oppfolging",
    label: "Oppfølging av spillere",
  ...
  // --- Sider · dyp-katalog (IA 2026-07-26, oppdatert AX-01 26.08.2026) ----
  // AgencyOS-railen har fem faste destinasjoner + «Under Meg»-rader
  // (v2/shell.tsx: AGENCYOS_SKALL_TABS/AGENCYOS_UNDER_MEG) — ingen
  ...
  { id: "s-integrasjoner", label: "Integrasjoner", description: "Koblinger til eksterne tjenester", keywords: ["integrasjon", "kobling", "api", "stripe", "google", "notion"], icon: Plug, kind: { type: "navigate", href: "/admin/oppsett?fane=integrasjoner" } },
  { id: "s-epostmaler", label: "E-postmaler", description: "Maler for utgående e-post", keywords: ["epost", "e-post", "mal", "template", "mail"], icon: MailCheck, kind: { type: "navigate", href: "/admin/email-templates" } },
  { id: "s-epost-inn", label: "E-post (post@)", description: "Innkommende e-post", keywords: ["epost", "e-post", "innboks", "post", "mail"], icon: Mail, kind: { type: "navigate", href: "/admin/innboks-epost" } },
  { id: "s-min-profil", label: "Min coach-profil", description: "Din offentlige coach-profil", keywords: ["profil", "min", "coach", "meg"], icon: User, kind: { type: "navigate", href: "/admin/profile" } },
  ...
  { id: "s-planer-alle", label: "Planer (alle)", description: "Plan-hub", keywords: ["plan", "planer", "alle", "oversikt"], icon: Layers, kind: { type: "navigate", href: "/admin/planlegge" } },
  { id: "s-okter", label: "Økter", description: "Åpne uke i Workbench", keywords: ["okt", "økt", "okter", "økter", "session"], icon: Clock, kind: { type: "navigate", href: "/admin/planlegge" } },
  ...
  { id: "s-gjennomfore", label: "Gjennomføre", description: "Kommende og pågående økter", keywords: ["gjennomfore", "gjennomføre", "utfor", "live"], icon: Play, kind: { type: "navigate", href: "/admin/kalender" } },
  { id: "s-periode-navn", label: "Periodenavn", description: "Koble ukjente periodenavn til periodetype", keywords: ["periode", "navn", "ukjent", "grunn", "spes", "turn"], icon: Tag, kind: { type: "navigate", href: "/admin/oppsett?fane=perioder" } },
  ...
  { id: "s-workspace", label: "Oppgaver", description: "Prosjekter, rutiner og det som er tildelt deg", keywords: ["oppgaver", "workspace", "prosjekt", "rutine", "handlingssenter", "arbeid"], icon: LayoutDashboard, kind: { type: "navigate", href: "/admin/oppgaver" } },
  { id: "s-rutiner", label: "Rutiner", description: "Gjentakende arbeid — hva en agent kan overta", keywords: ["rutine", "gjentakende", "daglig", "ukentlig", "automatiser"], icon: RefreshCw, kind: { type: "navigate", href: "/admin/oppgaver?fane=rutiner" } },
  { id: "s-marketing", label: "Marketing", description: "Markedsføring og kampanjer", keywords: ["marketing", "marked", "kampanje", "annonse"], icon: Megaphone, kind: { type: "navigate", href: "/admin/marketing" } },
  { id: "s-kalender-synk", label: "Kalender-synk (Google)", description: "Google Calendar-kobling", keywords: ["kalender", "synk", "google", "sync"], icon: RefreshCw, kind: { type: "navigate", href: "/admin/oppsett?fane=kalender" } },
  { id: "s-klubb", label: "Klubb-innstillinger", description: "Klubbens oppsett", keywords: ["klubb", "innstilling", "anlegg", "bane"], icon: Building2, kind: { type: "navigate", href: "/admin/oppsett?fane=klubb" } },
