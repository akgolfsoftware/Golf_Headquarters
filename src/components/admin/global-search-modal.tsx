...
const ACTIONS: Action[] = [
  ...
  { id: "s-innstillinger", label: "Innstillinger", description: "Systeminnstillinger", keywords: ["innstilling", "settings", "oppsett", "drift"], icon: Settings, kind: { type: "navigate", href: "/admin/settings" } },
  { id: "s-integrasjoner", label: "Integrasjoner", description: "Koblinger til eksterne tjenester", keywords: ["integrasjon", "kobling", "api", "stripe", "google", "notion"], icon: Plug, kind: { type: "navigate", href: "/admin/integrasjoner" } },
