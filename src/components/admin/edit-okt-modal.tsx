...
export function EditOktModal({
  ...
  return (
    ...
    >
      <div
        className="flex h-full max-h-[95vh] w-full flex-col overflow-hidden rounded-t-2xl border border-border bg-card shadow-xl sm:max-h-[920px] sm:max-w-[920px] sm:rounded-lg"
