...
export function AdminGjennomforeV2({ data }: { data: AdminGjennomforeData }) {
    ...
    <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: 14, flexWrap: "wrap" }}>
      <div>
        <div data-paper-pattern-topp>
          <h1 style={{ margin: 0, fontFamily: T.disp, fontSize: 17, fontWeight: 600, color: T.fg }}>Gjennomføre</h1>
  ...
  return (
    <div data-paper-wave-h="gjennomfore" data-paper-pattern style={{ display: "flex", flexDirection: "column", gap: T.gap, maxWidth: 960, margin: "0 auto", width: "100%" }}>
      {hode}
      {live}
      {kpi}
