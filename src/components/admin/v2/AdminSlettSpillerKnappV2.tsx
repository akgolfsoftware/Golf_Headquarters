  ...
  return (
    <>
      <button
        ...
        style={{ display: "inline-flex", alignItems: "center", gap: 8, borderRadius: 9999, border: `1px solid color-mix(in srgb, ${TL.danger} 40%, transparent)`, background: "transparent", padding: "10px 18px", fontFamily: TL.font.sans, fontSize: 13, fontWeight: 600, color: TL.text, cursor: "pointer" }}
      >
