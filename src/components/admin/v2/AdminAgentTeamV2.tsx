...
width: "100%", padding: "10px 16px",             background: T.handling, color: T.onHandling, minHeight: 52, borderRadius: 12, fontFamily: T.ui, fontSize: 14, fontWeight: 600,
  ...
  return (
    <div data-paper-agencyos-agenticos data-paper-wave-f="agenticos" data-od-id="agencyos-agenticos" data-paper-slug="agencyos-agenticos" style={{ display: "flex", flexDirection: "column", gap: T.gap, width: "100%" }}>
      {hode}
      {skjema}
      {resultat}
      {historikk}
