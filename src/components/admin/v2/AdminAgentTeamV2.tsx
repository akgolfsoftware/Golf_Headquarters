...
import { Caps, Kort, StatusPill, Inndata, Velger, TomTilstand, Icon, type StatusTone } from "@/components/v2";
  ...
  return (
    <Kort pad="14px 16px">
      <div style={{ display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }}>
        ...
        />
        <span style={{ fontFamily: TL.font.sans, fontWeight: 700, fontSize: 14, color: TL.text }}>{step.role}</span>
        <span style={{ fontFamily: TL.font.mono, fontSize: 9, fontWeight: 700, letterSpacing: "0.05em", textTransform: "uppercase", color: TL.mute }}>
          {label}
        </span>
        <span style={{ flex: 1 }} />
...
function HistorikkKort({ run }: { run: AgentTeamRunView }) {
  ...
  return (
    <Kort pad="4px 16px">
      ...
      >
        <Icon name={open ? "chevron-down" : "chevron-right"} size={16} style={{ color: TL.mute, flex: "none" }} />
        ...
        {run.projectName && (
          <span style={{ fontFamily: TL.font.mono, fontSize: 9, fontWeight: 700, letterSpacing: "0.05em", textTransform: "uppercase", color: TL.mute }} className="hidden md:inline">
            {run.projectName}
          </span>
        )}
        <span style={{ fontFamily: TL.font.mono, fontSize: 10, color: TL.mute, flex: "none", fontVariantNumeric: "tabular-nums" }}>{dato}</span>
...
export function AdminAgentTeamV2({ data }: { data: AdminAgentTeamV2Data }) {
  ...
  const hode = (
    <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: 14, flexWrap: "wrap" }}>
      <div>
        <h1 style={{ margin: 0, fontFamily: TL.font.sans, fontSize: 17, fontWeight: 600, color: TL.text }}>AgenticOS</h1>
        ...
        <p style={{ fontFamily: TL.font.sans, fontSize: 13, color: TL.mute, marginTop: 8, maxWidth: 520, lineHeight: 1.55 }}>
...
width: "100%", padding: "10px 16px",             background: TL.fill, color: TL.onFill, minHeight: 52, borderRadius: 12, fontFamily: TL.font.sans, fontSize: 14, fontWeight: 600,
          }}>
  ...
  return (
    <div data-paper-agencyos-agenticos data-paper-wave-f="agenticos" data-od-id="agencyos-agenticos" data-paper-slug="agencyos-agenticos" style={{ display: "flex", flexDirection: "column", gap: 16, width: "100%" }}>
      {hode}
      {skjema}
      {resultat}
      {historikk}
