 ...
 * AG-01 Cockpit lys.dc.html (mekanisk invertering via TL-tokens — bekreftet
 * PX-6 28.08: samme geometri, kun flatene snur), AG-02 Cockpit Mac.dc.html,
 * AG-14 Cockpit tom.dc.html, AG-15 Cockpit feil.dc.html.
