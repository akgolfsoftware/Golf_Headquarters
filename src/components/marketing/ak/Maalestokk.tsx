...
/* Kilde: designsystem/ak-golf/components/merke/Maalestokk.jsx.
   Streken med merker langs en kant. Sier «dette er målt» uten å skrive det. */

export function Maalestokk({
  retning = "vannrett",
  lengde = 200,
  style,
}: {
