...
import { PkSek, PkEyebrow, PkHero, PkIng, PkFilterrad, PkKat, PkTom } from "./kit/PkPrimitives";
    ...
    <PkShell aktiv="/blogg" dataSlug="marketing-blogg-liste">
        ...
        <PkSek notop>
          <Link href={`/blogg/${featured.slug}`} className="pk-kort pk-kort-hover" style={{ display: "block" }}>
            <div className="pk-featured">
              <div style={{ position: "relative", aspectRatio: "16 / 9", width: "100%", background: "var(--tl-dock)" }}>
              ...
              <div className="pk-kort-body">
                ...
                <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", gap: 16, marginTop: 16, fontFamily: "var(--tl-font-sans)", fontSize: 12.5, color: "var(--tl-mute)" }}>
                  <span style={{ color: "var(--tl-text)", fontWeight: 600 }}>{featured.forfatter}</span>
      ...
      <PkSek notop>
        <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between", marginBottom: 20 }}>
          <span style={{ fontFamily: "var(--tl-font-sans)", fontWeight: 600, fontSize: 22, color: "var(--tl-text)" }}>Nyere artikler</span>
    ...
    <Link href={`/blogg/${post.slug}`} className="pk-kort pk-kort-hover">
      ...
      <div className="pk-kort-body">
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <span style={{ display: "inline-flex", alignItems: "center", gap: 4, fontFamily: "var(--tl-font-sans)", fontSize: 11.5, color: "var(--tl-mute)" }}>
        ...
        >
          <span style={{ color: "var(--tl-text)", fontWeight: 600 }}>{post.forfatter}</span>
          <span style={{ fontFamily: "var(--tl-font-mono)", fontVariantNumeric: "tabular-nums" }}>{NB_DATE.format(new Date(post.dato))}</span>
        </div>
      </div>
    </Link>
  );
