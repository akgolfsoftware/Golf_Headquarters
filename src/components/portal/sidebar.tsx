...
const MAIN_ITEMS: NavItem[] = [
  { href: "/portal", label: "Hjem" },
  {
    ...
    children: [
      { href: "/portal/planlegge/workbench", label: "Workbench" },
      { href: "/portal/mal", label: "Mål & utfordringer" },
  ...
  },
  {
    ...
    children: [
      ...
      { href: "/portal/gjennomfore", label: "Dagens & logg" },
    ],
  },
  {
    ...
    children: [
      { href: "/portal/analysere", label: "Min golf" },
