  ...
  return (
    <div className="flex min-h-screen min-h-dvh bg-background">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header
          role="banner"
          className="safe-top sticky top-0 z-30 flex items-center justify-between gap-2 border-b border-border bg-card/85 px-4 py-2 backdrop-blur-md sm:gap-4 sm:px-8 sm:py-4"
        >
