...
const ACTIONS: Action[] = [
  ...
  },
  {
    id: "sg-hub",
    label: "SG Hub",
    description: "Strokes gained per kølle og strategi",
    keywords: ["sg", "hub", "kølle", "strokes", "gained", "benchmark"],
    icon: TrendingUp,
    kind: { type: "navigate", href: "/portal/mal/sg-hub" },
  },
  {
    id: "log-round",
    label: "Logg runde",
    description: "Registrer ny runde med slag",
    keywords: ["runde", "logg", "score", "golf", "slag"],
    icon: Flag,
    kind: { type: "navigate", href: "/portal/mal/runder/ny" },
  },
  {
    id: "trackman",
    label: "TrackMan data",
    description: "Se og importer TrackMan-sesjoner",
    keywords: ["trackman", "data", "swing", "import", "sesjon"],
    icon: Activity,
    kind: { type: "navigate", href: "/portal/mal/trackman" },
  },
  {
    id: "workbench",
    label: "Åpne Workbench",
    description: "Planlegging – uke, gantt, økter",
    keywords: ["workbench", "planlegg", "uke", "gantt", "plan"],
    icon: ClipboardList,
    kind: { type: "navigate", href: "/portal/planlegge/workbench" },
  },
  {
    id: "stats",
    label: "Statistikk",
