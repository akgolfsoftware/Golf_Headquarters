    ...
    <div className={cn("mx-auto w-[430px] max-w-full rounded-[16px] border border-border bg-card p-6", className)}>
      ...
      {step === 0 && (
        <div>
          ...
          <button type="button" onClick={() => setStep(1)} className="mt-4 inline-flex w-full items-center justify-center gap-1.5 rounded-lg bg-primary px-4 py-2.5 font-mono text-[11px] font-extrabold uppercase tracking-[0.10em] text-primary-foreground">
      ...
      {step === 1 && (
        <div>
          ...
          <button type="button" onClick={() => setStep(2)} className="mt-4 inline-flex w-full items-center justify-center gap-1.5 rounded-lg bg-primary px-4 py-2.5 font-mono text-[11px] font-extrabold uppercase tracking-[0.10em] text-primary-foreground">
