...
/* Offisiell AK Golf-logo (assets/logos/ak-golf-logo-primary-on-dark.svg) */
export function LogoAK({ size = 26, color = "rgb(209,248,67)", style }: LogoAKProps) {
  return (
    <svg width={size} height={Math.round((size * 470) / 538)} viewBox="0 0 538 470" fill="none" style={style} aria-label="AK Golf">
      <g transform="translate(0,470) scale(0.1,-0.1)">
        ...
        <circle cx="4840" cy="3620" r="310" fill={color}></circle>
      </g>
    </svg>
  );
}
