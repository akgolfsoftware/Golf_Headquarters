...
import {
  ...
  Flame, GripVertical, CircleHelp, Image as ImageIcon, Info, Mail, Megaphone, Menu,
  ...
  Trophy, Flag, List, LayoutGrid, LayoutDashboard, SlidersHorizontal, Sun, Moon, CalendarPlus, Crosshair,
  ...
  Pause, Printer, Share2, ThumbsUp, ThumbsDown, Headphones, Wifi, Wind, Link2, UserPlus,
  type LucideIcon,
} from "lucide-react";
