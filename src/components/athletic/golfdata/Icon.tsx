/**
 * AK Golf HQ — Icon
 * Lucide-geometry glyphs at 1.5px stroke. Lucide is the brand's only icon
 * system; this primitive inlines the curated subset the components need so the
 * library stays dependency-free. For the full Lucide set in product code, load
 * the Lucide CDN and match this stroke width.
 */
...
const PATHS: Record<string, string> = {
  ...
  /* ---- Paths added for nav / overlay / form components ---- */
  ...
  megaphone:    '<path d="M11 5.882V19.24a1.76 1.76 0 0 1-3.417.592l-2.147-6.15M18 13a3 3 0 1 0 0-6M5.436 13.683A4.001 4.001 0 0 1 7 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 0 1-1.564-.317z"/>',
  ...
  /* ---- Contact / settings / profile glyphs ---- */
...
/** Names available in the inlined set (for editor hints / iteration). */
