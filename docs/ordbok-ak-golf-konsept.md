...
→ Flyttet til `docs/design-guide-terminologi.md` §5 (tekster + stiler + app-idiom).
...
→ Flyttet til `docs/design-guide-terminologi.md` §6.

## B20. Hero-titler

→ Flyttet til `docs/design-guide-terminologi.md` §7.

## B21. Personas (demo-data)

→ Flyttet til `docs/design-guide-terminologi.md` §8. Demo-kanon: Øyvind Rohjan (spiller) + Anders Kristiansen (coach); Markus Røinås Pedersen er EKTE coach, aldri demo-spiller.

## B22. Klubber & lokasjoner (demo-data)

→ Flyttet til `docs/design-guide-terminologi.md` §9.
...
1. **Endre i canon først** (MasterBrain) hvis det gjelder konsept-verdier — deretter denne fila → `docs/design-guide-terminologi.md` (visning) → `docs/ordbok.json` (regenerer med `npx tsx scripts/ordbok-json.ts`) → kode.
