...
| P0-TEST | Grok | Isolert Postgres-reise med testidentitet prøvd 12.09. Innlogget Next mot lokal Supabase mangler. [Bevis](design-audit/p0-test-blokkering-2026-09-12.md) · [lanseringsprøve](design-audit/docker-launch-tester-2026-09-12.md) | Syntetiske roller mot HQ-skjema i egen stack; kritiske prøver hopper ikke over manglende oppsett; betaling/e-post bruker testmiljø |
...
| R-I utstyrsbag | Forelder avvises. Lagring bruker innlogget bruker-id. Felt over 200 tegn avvises | På `grok/r-i-utstyrsbag-2026-09-13`. [Kontroll](design-audit/handlingstilgang-utstyrsbag-2026-09-13.md) |
...
| Plan/Live | Frekvens, FYS-gjenåpning og serverregler for ny/rediger/flytt er prøvd. Innlogget reise og Caddie i live gjenstår | [P02–P05](design-audit/plan-live-p02-p05-2026-09-12.md) · [ny/rediger/flytt](design-audit/plan-ny-rediger-flytt-2026-09-13.md). Separate modeller beholdes |
...
| Kodekontroll · R-I | Første utvalg i PR #848. Fortsettelse: opptatt tid, profil og mål. Utstyrsbag prøvd 13.09. Øvrige skriv gjenstår | [R-I](design-audit/handlingstilgang-r-i-2026-09-12.md) · [bred](design-audit/handlingstilgang-bred-2026-09-12.md) · [utstyrsbag](design-audit/handlingstilgang-utstyrsbag-2026-09-13.md) |
