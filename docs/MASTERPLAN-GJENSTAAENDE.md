...
| 18.3 | ~~**Merkearkitektur**~~ **GJORT 31.08.2026.** `designsystem/ak-golf/guidelines/02-arkitektur.md`: fem varianter under paraplyen, hver med navnebruk og identitetsfarge; Mulligan står utenfor; Team Norway unntatt (Claw). Konfliktregelen AK Golf → Train-lock → Claw er skrevet ut. **Lukker beslutningskøen punkt 22:** WANG-coaching er variant «Organisasjon» `#4E6A7E` — ikke skolens egen navy, siden WANG er kunde og ikke avsender | Hvordan Academy, Junior Academy, Mulligan, Skarpnord Golf Products og WANG-coachingen henger under paraplyen: navnebruk, logobruk, én identitetsfarge hver, felles skjelett. Lukker beslutningskøen punkt 22 helt |
