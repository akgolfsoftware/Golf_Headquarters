...
| 15.9 | **Plan — LEVERT, IKKE MERGET (PR #704 åpen, verifisert 31.08.2026)** | `admin/planlegge`, `admin/plan-templates` (+`/ny`), `admin/teknisk-plan` | «Planlegge er ett trykkpunkt til Workbench» (beslutning 21.07) gjelder fortsatt. Gjenstår: gjennomgå + merge #704 |
