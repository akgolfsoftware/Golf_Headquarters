...
**Status 31.08.2026 (kveld): 10 av 13 MERGET** (15.1–15.3, 15.5–15.10, pluss 15.4 Kalender
som PR #708 — 15.8 kom inn som #706, 15.9 som #704) · 15.11 Stall-lista levert i PR #710
(merges når grønn, Anders' «Merge alle» 31.08) · gjenstår å bygge: 15.12 talent-flyttingen,
15.13 de 36 uten vei inn.
...
| 15.13 | **De 36 skjermene uten vei inn** | **LEVERT, IKKE MERGET (PR #711).** Kun de 10 AgencyOS-adressene (PlayerHQ er ikke i denne konsolideringen). 7 av 10 trengte arbeid — `settings/api`/`settings/security` var allerede løst av 15.3. GDPR/eksterne lesere: lenke-rad i Oppsett. Videoer/turnering-kobling: knapper på spillerkortet. AK-stigen: knapp i Stall-hodet. Kalender-hendelse: lenke i den levende kalenderen (`KalenderLagUkeV2`, den gamle var i død kode). Moderering: sjette Kø-fane. `wagr-import` bevisst hoppet over — venter på talent→innsyn-arkitekturen (15.12, org-skall N9). | Etter 15.1–15.12: gå gjennom lista i `docs/arkitektur-kartlegging-2026-08-30.md` og gi hver enten en inngang eller en redirect. Ingen skjerm skal stå igjen uten vei inn |
