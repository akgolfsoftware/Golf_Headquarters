...
| # | Oppgave | Detalj |
|---|---|---|
| 17.1 | **Poster, ikke chat** | Trener poster til gruppe og til enkeltspiller, med video, bilder, lenker og vedlegg (flybilletter, hotellreservasjoner). **Ingen fri chat.** 1:1-poster til mindreårige skal være sporbare og synlige for forelder (idrettens åpenhetsprinsipp) — det er et krav til datamodellen, ikke en UI-detalj. **Design bestilt 31.08.2026:** `designsystem/team-norway/prompt-batch-3.md` (TN-09/TN-10) |
