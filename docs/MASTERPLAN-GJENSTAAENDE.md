...
| Ø14 | ~~tir 22.09~~ **gjort 02.09** | F2 AgencyOS | Stall — sign-off (15.11-etterkontroll). **Gjort:** bolker vs. flat liste er FRA FØR dokumentert som bevisst avvik (15.11), ikke rettet på nytt. Tom-tilstand skjermbildet 390/1280 × lys/mørk — OK. Selve rad-visningen ikke re-verifisert (ingen testspillere i stallen, basen nullstilt 30.08) | `/admin/spillere` | `AG-04 Stall.dc.html` · `AG-16 iPad Stall split.dc.html` | Agent |
| Ø15 | ~~ons 23.09~~ **gjort 02.09** | F2 AgencyOS | Kommunikasjon — sign-off (15.7-etterkontroll). **Gjort:** skjermbildet 390/1280 × lys/mørk mot ekte seed-data — fire faner + Godkjenninger-listen OK i alle fire, ingen brudd | `/admin/kommunikasjon` | `AG-03 Innboks.dc.html` | Agent |
