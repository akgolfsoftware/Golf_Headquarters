...
| R-A/R-B/R-C/R-D/R-H | Caddie-ressursgrenser og AI-minimering, privat lokal lagring, TrackMan-enheter og sikker abonnementshenting | I main via samlingsarbeidet. [Kontroll og åpne grenser](vedlikehold/sikkerhet-og-enheter-2026-09-11.md). Innlogget R-E/R-C-kontroll for abonnement, Caddie-gate, TrackMan CSV/HTML og privat lokal lagring er i main via PR #886–#888; produksjonsbevis og AI/foto-reise gjenstår |
...
| R-E Caddie-tilgang og TrackMan CSV/HTML | ADMIN slipper forbi `/api/caddie/chat`-gaten (ekte cookies, ingen side finnes ennå); COACH og uinnlogget avvises 401. Full skjermflyt for TrackMan CSV- OG HTML-import med eksplisitte enheter | I main via PR #887, merge `e565264b6`. [Kontroll](design-audit/caddie-trackman-r-e-2026-09-13.md). Caddie AI-svar og TrackMan foto-kilde er bevisst udekket (`ANTHROPIC_API_KEY`) |
| R-C privat lokal lagring | Ekte to-brukers offline/kølagt-scenario på samme nettleser-context uten manuell opprydding: spillerens kølagte tapper-telling er eier-navnerommet i IndexedDB, en fremmed spiller som logger inn rett etter arver aldri tellingen | I main via PR #888, merge `0fd4e593d`. [Kontroll](design-audit/lokal-lagring-r-c-2026-09-14.md). Øvrige lokal-lagringsmekanismer uten egen innlogget e2e gjenstår |
...
Aktiv arbeidsdeling 14.09.2026: **kode ferdigstilles først**, deretter evalueres Claude Design-status før eventuell D0-lås og portering. R-A–R-E innenfor trygt omfang er i main via PR #886–#888 (`0fd4e593d`). Ikke bygg visuelt fra kandidat v0.4.10 (eller nyere) før kodepakken under er lukket og Anders har levert designstatus til evaluering.

| Prioritet / ID | Konkret neste leveranse | Inngang | Ferdig når |
|---|---|---|---|
| 1 · KODE-A | Lukke funksjonell kode før designlås: resterende innloggede reiser og handlinger som allerede har serverregler (Plan ny/rediger/flytt, Workbench gruppeplan uten dublett, øvrige R-I admin-skriv som er i inventaret), plus stabilisere kjent flake i `spillerreise-innlogget.spec.ts` | Main `0fd4e593d`, P0-stack, eksisterende design-audit-kontroller | Berørte reiser er innlogget prøvd eller ærlig markert blokkert; flake er rettet eller isolert; ingen åpen P0-kodeblokk uten eier |
| 2 · KODE-B | Booking/betaling og betaling for barn med Stripe-testnøkkel (R4–R9): avbrudd, retur, gjentakelse, eierskap | O06/O05 i main; Stripe-testmiljø og innloggede testroller | Testbetaling og refusjon består uten reell belastning; idempotens og eierskap er bevist |
| 3 · KODE-C | Bevisst udekkede AI-reiser bare hvis Anders autoriserer trygt oppsett: Caddie AI-svar og TrackMan foto (krever `ANTHROPIC_API_KEY` — ikke i sky-test). Ellers forblir de dokumentert udekket | PR #877/#887-begrensninger | Enten bestått innlogget kontroll i avtalt trygt miljø, eller eksplisitt utsatt med eier og begrunnelse |
| 4 · DESIGN-EVAL | Anders leverer nåværende Claude Design-status. Code Xpert evaluerer dekning (familier/reiser/ruter), hull (P11/O11/O12, J07, TrackMan→bag, Gameplan/GPS m.m.), konflikt mot kodefasit, og anbefaler hva som mangler før `selectedForBuilding: true` | Claude Design-eksport + designregister + denne masterplanen | Skriftlig evaluering: har-vi-nok / gap-liste / anbefalt polish (Impeccable/Emil/Taste uten å overstyre Atletisk intelligens) |
| 5 · D0 → D1 | Først etter KODE-A/B (og evt. C): velg én pakke og koble ruter/tilstander/handlinger | Evalueringen i prioritet 4 | Pakke med versjon, hash, avtalt dekning og `selectedForBuilding: true`; D1-kart uten skjult schema |
| 6 · L3/L7/L8 | Visuell tilgjengelighet, alarm/gjenoppretting og kontrollert produksjonsreise | D6 og eksplisitt miljøautorisasjon | Kontrast, 320 px, 200 %, alarmer, restore/rollback og eksakt produksjonscommit er dokumentert bestått |

**Parkert til etter kode:** tidligere prioritet «1 · D0 / 2 · D1» startes ikke før prioritet 4 (DESIGN-EVAL) er ferdig. R-A–R-E (#886–#888) er allerede lukket innenfor trygt omfang.
...
| Plan/Live | Frekvens, FYS-gjenåpning og serverregler for ny/rediger/flytt er prøvd. Innlogget ny/rediger/flytt og Caddie i live gjenstår | [P02–P05](design-audit/plan-live-p02-p05-2026-09-12.md) · [ny/rediger/flytt](design-audit/plan-ny-rediger-flytt-2026-09-13.md). Separate modeller beholdes |
...
| Kodekontroll · R-I | PR #848, #856, #866, #869 og #870 i main. Helseskriving i denne leveransen. Øvrige admin-skriv gjenstår | [R-I](design-audit/handlingstilgang-r-i-2026-09-12.md) · [bred](design-audit/handlingstilgang-bred-2026-09-12.md) · [O02](design-audit/workbench-o02-publisering-2026-09-13.md) · [utstyrsbag](design-audit/handlingstilgang-utstyrsbag-2026-09-13.md) · [admin-spiller](design-audit/handlingstilgang-admin-spiller-2026-09-13.md) · [helse](design-audit/handlingstilgang-helse-2026-09-13.md) |
