...
| D2-TN teknisk reise | Oversikt → poster/dokumenter → spillerpost → testføring → historikk uten visuell port. Poster og dokumenter låst til kanonisk Team Norway-gruppe | Bygget på `grok/d2-tn-teknisk-reise-2026-09-12`. [Kontroll](design-audit/team-norway-d2-tn-teknisk-reise-2026-09-12.md) |
