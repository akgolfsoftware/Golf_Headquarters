...
| 1b · CD-2 | Workbench v0.7-prompt: fasilitet først med mål, reps per motorikk-steg, gruppeuke med kopi til spillere, delt økt med ansvarlig trener, teknisk plan ↔ P-oppgaver ↔ TrackMan-mål. Claude skriver prompten fra masteren og `WORKBENCH-KRAV.md`; Anders sender den | `docs/planer/design/` (ny prompt-fil) | v0.7 finnes i prosjektet, klikkprøvd 390/834/1440, WB-05–WB-10 + kalender dag/uke/måned/agenda i én fil; Anders har sett den på 390 |
