...
| R-E Caddie-tilgang og TrackMan CSV | ADMIN slipper forbi `/api/caddie/chat`-gaten (ekte cookies, ingen side finnes ennå); COACH og uinnlogget avvises 401. Full skjermflyt for TrackMan CSV-import med eksplisitte enheter | Lokale commits på `codex/r-e-caddie-trackman-2026-09-13`. **Ikke pushet, ikke PR, ikke flettet.** [Kontroll](design-audit/caddie-trackman-r-e-2026-09-13.md) |
...
| 3 · R-A–R-E | Kjør innlogget Caddie-, TrackMan-, lokal lagrings- og abonnementsreise med syntetiske testbrukere. **Abonnement/tilgangsnivå i main via PR #886.** **Caddie-tilgang (API, ingen side ennå) og TrackMan CSV bestått 13.09** (gren `codex/r-e-caddie-trackman-2026-09-13`, ikke flettet); lokal lagring, Caddie AI-svar og TrackMan HTML/foto gjenstår | Eksisterende sikkerhetsregler og PR #877 | Tillatt rolle virker, uvedkommende avvises, feiltilstander er ærlige og ingen persondata sendes ukontrollert |
