...
| 0.6 | **Avklar marketing-redesignet (#565–#568, 18.–20.08) mot PORTPLAN §B4/W5.** Nytt lyst skall, ny forside, `/mulligan`, booking i nytt skall — hentet fra `ak-golf-website`, men ikke koblet til rutefasit/PORTPLAN. Dekker det de 38 W5-rutene som venter på design (2.6 under), eller er det et eget spor med egen skjermbilde-gate-runde? | Anders | git-historikk 21.08, ikke i noen plan |
