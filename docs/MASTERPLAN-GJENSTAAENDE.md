...
|---|---|---|---|
| 1 · R-E / R1–R3 | Fullfør innlogget Next-/databasereise I dag → Plan → PH-04 → PH-05 → PH-06 for V2, Workbench og eldre plan. Enhetstester og V2-øktark-tilgang er levert; isolert testdatabase er blokkert | `src/lib/portal-live/spillerreise.ts`, `src/lib/portal-okt/okt-detalj-tilgang.ts`, [kontroll](design-audit/playerhq-r-e-spillerreise-2026-09-12.md) | Samme økt/tall i innlogget isolert base; gjenåpning virker; uvedkommende avvises. Kritiske prøver gir ikke grønt ved å hoppes over |
