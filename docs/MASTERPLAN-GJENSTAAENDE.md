...
| P0-TEST | Grok | Blokkert uten Docker/testbase | Separat tom testdatabase kan bygges etter gjeldende oppskrift; syntetiske spiller-, coach-, organisasjons- og avviste roller finnes; kritiske prøver hopper ikke over manglende oppsett; betaling/e-post bruker testmiljø |
...
|---|---|---|---|
| 1 · P0-TEST → R-E / R1–R3 | Fullfør innlogget Next-/databasereise I dag → Plan → PH-04 → PH-05 → PH-06 for V2, Workbench og eldre plan. Enhetstester og V2-øktark-tilgang er levert i PR #845; isolert testdatabase er blokkert uten Docker | `docs/utvikling/lokal-testdatabase.md`, `src/lib/portal-live/spillerreise.ts`, `src/lib/portal-okt/okt-detalj-tilgang.ts`, [kontroll](design-audit/playerhq-r-e-spillerreise-2026-09-12.md) | P0-TEST er bestått; samme økt/tall i innlogget isolert base; gjenåpning virker; uvedkommende avvises. Kritiske prøver gir ikke grønt ved å hoppes over |
