...
| 18.20 | **Merkeboka og bestillingen må følge verkstedet** | `designsystem/ak-golf/merkebok.html` og `prompt-claude-design.md` viser fortsatt krem `#FAF9F5`, clay `#D97757` og Archivo Narrow. De må legges om til betonggrå `#E8E4DC`, signal `#B83217` og IBM Plex før bestillingen sendes til Claude Design. **Ren mekanisk oppdatering — ingen nye beslutninger** |
