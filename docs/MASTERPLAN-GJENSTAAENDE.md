...
| 18.23 | **Retusjerte bilder i repoet** | `public/brand/foto/renset/` — fem bilder der PUMA-logoen er fjernet (#3, #9, #12, #14, #41). Originalene er urørt. Kildepakke-skriptet foretrekker renset der den finnes. **Gjenstår:** #12 fikk en synlig firkantet artefakt og må gjøres på nytt; de øvrige bildene i arkivet er ikke gjennomgått — malsøket ga for mye støy til å stole på uten manuell kontroll |
