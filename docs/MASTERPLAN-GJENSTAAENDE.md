...
| P0-TEST | Grok | Delvis 12.09 kveld: egen HQ-Supabase, innlogget Workbench- og planreise samt avvist uvedkommende. V2-fullføring i UI gjenstår. [Bevis](design-audit/p0-test-innlogget-reise-2026-09-12.md) | Syntetiske roller mot HQ-skjema i egen stack; kritiske prøver hopper ikke over manglende oppsett; betaling/e-post bruker testmiljø |
...
|---|---|---|---|
| 1 · P0-TEST → R-E / R1–R3 | Innlogget HQ-Supabase: Workbench og eldre plan fullført med tall og gjenåpning; uvedkommende avvist. V2-fullføring i UI gjenstår | `scripts/p0-test-innlogget-reise.mjs`, [kontroll](design-audit/p0-test-innlogget-reise-2026-09-12.md) | P0-TEST er bestått når også V2-live fullføres i nettleseren mot samme isolert base |
