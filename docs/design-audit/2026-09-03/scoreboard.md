...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|
| `portal/planlegge` | 3 | 9 | **3,2** | 0 | 0 | 0 | 9 | 86 | 17 | 0 | 0/4 | ukalibrert |
| `admin/plan-templates` | 3 | 11 | **4,2** | 1 | 6 | 0 | 3 | 25 | 19 | 0 | 0/2 | ingen |
...
| `admin/trackman` | 2 | 6 | **7,1** | 1 | 0 | 0 | 2 | 14 | 7 | 0 | 0/0 | ingen |
...
| `admin/turnering` | 1 | 7 | **7,8** | 1 | 0 | 0 | 2 | 8 | 7 | 0 | 0/0 | ingen |
...
| `admin/spillere` | 8 | 23 | **8,4** | 2 | 0 | 0 | 4 | 31 | 29 | 0 | 0/0 | ukalibrert |
...
| `admin/grupper` | 6 | 16 | **8,9** | 1 | 0 | 0 | 3 | 6 | 7 | 0 | 0/0 | ingen |
| `admin/agencyos` | 5 | 19 | **8,9** | 1 | 0 | 0 | 3 | 18 | 7 | 0 | 0/0 | ingen |
