> # UTDATERT — ARKIVERT 2026-06-14
> Dette dokumentet (1. juni) er **ikke lenger gjeldende**. Det bruker det gamle navnet «CoachHQ»
> (skal være **AgencyOS**), gamle demo-navn, og er skrevet før AgencyOS-renaming + Fase 3/4.
> **Kanon er nå:** `docs/platform/AGENT-BRIEF.md` (inngang) · `docs/platform/BUSINESS-RULES.md`
> (låste beslutninger) · `docs/STATUS-NÅ.md` (nåstatus) · `docs/AAPNE-SPORSMAAL.md` (uavklart).
