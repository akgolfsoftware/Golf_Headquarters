...
| PX-4 | Piksel-bølge WB/P/RU/LO (Player-workbench, min uke/økt, live runde, gate) — to økter på samme gren. 7/27 sitert: RU-01/RU-01L (live-runde geometri: 72px tall, sirkulær −/+, pille-CTA), RU-02 (recap, hullgrid forenklet til én linje/radius 6 + sitert), RU-04 (etterregistrering, allerede nær — kun sitering), WB-00 (komponentreferanse, dekket av A-familiens sitater i `WeekGrid.tsx`), WB-04 (godkjenningskort i «I dag»: tittel/pyramide-chip/coach-notat), P-05 (DagNivaa rad-geometri: 44px tidskolonne, hairline-rader). 20 filer dokumentert som GAP i koden (ikke bygget) — se `docs/natt/PIKSELPLAN-2026-08-28.md` §2 og PR-beskrivelsen for full liste og begrunnelse per fil (LO: `/auth` låst lys vs. fasitens mørke + ny app-velger-rute mangler; P-01/02/03/04/08/09: `WorkbenchV2.tsx` er 3300 linjer delt coach/spiller, for stor/risikabel å pikseldiffe blindt uten skjermbilde; WB-01/02/03/05/06/07/09: rene Agency-Mac/iPad-rammer, ikke spiller-scope; WB-08: krever GROUP-versjonskonflikt-domene som ikke finnes; WB-10: krever ny «Ikke delta»-handling på allerede-publiserte gruppeøkter; RU-03: duplikat av PH-12, PH-familiens scope). Ingen skjermbilder tatt (ingen credentials i miljøet). | `px/4-player-wb-runde` | Se PR |
