...
Dette dokumentet er kilde til sannhet for tilgang og gruppe-propagasjon. Ved konflikt med eldre tekst i HANDOFF eller integration/player-hq.md vinner **dette** dokumentet på access/group-spørsmål.
