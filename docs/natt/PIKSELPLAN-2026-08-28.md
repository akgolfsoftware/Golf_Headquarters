...
| PX-6 | AG (4) + AO (5) + JV (3) + S3 (3) + KA (3) + EC (2) + DG/FY/TU/GP/BO/ME-rest | ~28 | AgencyOS-resten: cockpit-varianter, AgenticOS, Jarvis, Spiller 360, kalender, økonomi, DataGolf, fys, turneringer, gameplan, booking, meg-detaljer. **STATUS 29.08: 21/32 sitert** (draft PR, `px/6-agency-rest`) — KA/EC/DG/GP/BO/ME fullført (allerede token-rene, manglet kun `Fasit:`-linjen); AG 2/4, AO 4/5 sitert. **Gjenstår som ekte funksjonsgap** (ikke bare visuell justering — se PR og `docs/feillogg.md`): AG-11 Kalender dag (tidsakse m/ overlapp+nå-linje), AG-19 Notifikasjonssenter, AO-13 Routing-hub, JV-01–03 Jarvis-merge-kø (domene finnes i `src/lib/domain/jarvis-merge/`, ingen UI/dataloader), S3-01L/02/03 Spiller 360 (fortsatt Paper, jf. T4s avvik-notat), FY-01 Fys stall (ACWR — ingen datamodell), TU-02 (turnering-detalj mangler klasse/felt/cut + gameplan-lenke, GP-01/02 selv er ferdig). | `px/6-agency-rest` |
