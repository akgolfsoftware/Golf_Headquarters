...
> Autoritativ oversikt over alle skjermer i plattformen. Én plass å se alt. **Sist oppdatert: 4. august 2026.**
>
> **VISUELL FASIT = Paper-only:** `designsystem/paper/fase1/*.html`. Denne filen er rute/status-kart — ikke mockup. `public/design-handover/`, `docs/skjermtekst/` og `docs/design-bestillinger/` er SLETTET.
