...
- Workbench: rettet seks puttebånd fra meter til fot og visningsnavnene Utslag, Golfslag og Banespill etter `docs/ordbok.md`. Lagrede identifikatorer er uendret.
