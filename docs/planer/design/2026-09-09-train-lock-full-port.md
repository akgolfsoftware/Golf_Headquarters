> **Datert underplan, bevart 10.09.2026.** Nåstatus og rekkefølge eies av `docs/MASTERPLAN-GJENSTAAENDE.md`. Coach-menyen ble avgjort 09.09: prototypen vinner, AX-01 overstyres. Gamle gren- og ferdigtall nedenfor må kontrolleres før bruk.
