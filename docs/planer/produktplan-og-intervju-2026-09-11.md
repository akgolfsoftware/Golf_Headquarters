...
| R-I Sterkere tilgangskontroll i kode | **REV-F10:** Kontroller faktiske eksporterte handlinger og ressursavgrensning; bygg avvisningstester. | En handling med importert, men ubrukt tilgangsvakt avdekkes. Testene bekrefter avvisning, ikke bare at en hjelpefunksjon importeres. | Innfør gradvis per berørt modul. Statisk kodeanalyse er et supplement til faktiske prøver. Kilde: `scripts/check-action-auth.mjs`. |
