...
| Privat lokal lagring · R-C | IndexedDB, localStorage og sessionStorage avgrenses til serververifisert bruker. Autentiserte sider og Next-data går bare til nettverk. Dobbel lagringsfeil gir et vedvarende varsel. | Eldre eierløse data beholdes urørt og leses ikke automatisk. Ekte innlogget ende-til-ende-kontroll gjenstår. [Detaljert kontroll · historisk Git-versjon](https://github.com/akgolfsoftware/Golf_Headquarters/blob/4fc72569c04622101e9affddb496ba3b8ebac8fa/docs/design-audit/lokal-lagring-personvern-2026-09-11.md). |
