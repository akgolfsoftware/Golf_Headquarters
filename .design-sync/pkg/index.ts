...
export { LogoAK, Caps, Tittel, DeltaChip, StatusPill, Tag, SevChip, AkseChip, MikroMeta, Kort, TallHero, KpiFlis, PillTabs, PillVelger, FilterChips, CTAPill, TilbakeLenke, Knapp, AvatarInit, AvatarFoto, Rad, FordelingHode, FordelingRad, AkseBar, Prikker, NivaSkala, Trend, InnsiktChip, TomTilstand, IkonRail, Sidebar, BunnNav, Skjerm } from "../../src/components/v2/core";
...
export { Bit, AKFormelChip, BenchmarkBadge, DiffKort, FleksMerke, LiveStatus, NivaStige, OppgaveKort, SGSplittKort, VelvaereKort, TidsVelger, BarnProgresjonKort } from "../../src/components/v2/domene2";
