...
- Priser: GRATIS · PRO 299 kr/mnd · PRO årlig 2690 kr (rett 300→299 i demoer ved besøk).
...
- `skills/ak-terminologi/SKILL.md` — terminologi-/rettskrivingsfasit for all norsk UI-tekst; `skills/ak-terminologi/ordbok.md` = full ordbok (CANON v3.5, lagt inn 3. jul). Kanon-konflikter BESLUTTET 3. jul (Anders): **A = beste kategori** (kit korrekt, ordbokens A=nybegynner forkastet) · **CS50–CS100** (seks nivåer, ikke CS20–100) · **putting alltid fot** (m→ft migrert i hele kit-et, 22 strenger) · **299 kr** (ordbokens «300» stale). Nærspill/innspill forblir meter.
