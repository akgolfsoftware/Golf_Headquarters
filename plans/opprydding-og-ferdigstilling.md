...
4. **2D — Fiks brutte pekere: LØST 2026-07-03.** `docs/STATUS-NÅ.md` pekte på `docs/redesign-2026-06/P0-status.md` som ikke fantes i repoet — pekeren er fjernet, P0-innholdet lå allerede inline i STATUS-NÅ. Samtidig oppdatert: `CLAUDE.md`, `.claude/rules/design-porting-gate.md`, `docs/platform/AGENT-BRIEF.md` og `docs/platform/screen-context/all-screens.md` (30 Fasit-linjer) pekte fortsatt på `public/design-handover/AK Golf HQ Design System/` — nå rettet til `docs/design-handover-2026-06-24/`. **NB — dette står i spenning med FASE 2 sin premiss rett over** (at `public/design-handover/` er låst 2026-06-04-sannhet): den nyere 24. juni-handoveren later til å ha avløst 4. juni-versjonen i praksis (samme undermappe `AK Golf HQ Design System/` finnes ikke lenger, verken i git eller lokalt), men dette er ikke eksplisitt bekreftet av Anders. Bekreft hvilken av de to som faktisk er gjeldende før FASE 2 lukkes helt.
